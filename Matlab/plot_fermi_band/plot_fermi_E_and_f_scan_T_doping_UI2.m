...
uicontrol(fig, "Style","text", "Units","normalized", ...
    ...
    "String","T idx", "BackgroundColor","w", "FontSize", 10, ...
...
uicontrol(fig, "Style","text", "Units","normalized", ...
    ...
    "String","mu idx", "BackgroundColor","w", "FontSize", 10, ...
    "HorizontalAlignment","left");
...
uicontrol(fig, "Style","text", "Units","normalized", ...
    ...
    "String","file idx (under T,mu)", "BackgroundColor","w", "FontSize", 10, ...
    "HorizontalAlignment","left");
...
uicontrol(fig, "Style","text", "Units","normalized", ...
    ...
    "String","band n", "BackgroundColor","w", "FontSize", 10, ...
    "HorizontalAlignment","left");
